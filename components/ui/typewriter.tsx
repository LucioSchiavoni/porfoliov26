...
export const TypewriterEffectSmooth = ({
    ...
    return (
        <div className={cn("flex space-x-1 my-6 w-full relative z-10", className)}>
            <motion.div
            ...
            >
                <div
                    className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold whitespace-normal"
                >
                    {renderWords()}{" "}
                </div>{" "}
            </motion.div>
            <motion.span
                ...
                className={cn("block rounded-sm w-[4px] h-8 sm:h-10 md:h-12 lg:h-16 xl:h-20 bg-blue-500", cursorClassName)}
            ></motion.span>
        </div>
    )
}
